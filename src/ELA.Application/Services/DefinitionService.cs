...
public class DefinitionService
{
    ...
    public async Task<ExampleDto> AddExampleAsync(Guid vocabularyId, Guid definitionId, AddExampleDto dto)
    {
    ...
    public async Task RemoveExampleAsync(Guid vocabularyId, Guid definitionId, Guid exampleId)
    {
        var vocab = await _vocabularyRepository.GetByIdAsync(vocabularyId)
            ?? throw new Exception($"Vocabulary {vocabularyId} not found");
